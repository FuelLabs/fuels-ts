...
- [Contract](../classes/internal-Contract.md)
...
- [FunctionInvocationResult](../classes/internal-FunctionInvocationResult.md)
- [FunctionInvocationScope](../classes/internal-FunctionInvocationScope.md)
- [Interface](../classes/internal-Interface.md)
- [InvocationCallResult](../classes/internal-InvocationCallResult.md)
- [InvocationResult](../classes/internal-InvocationResult.md)
- [MultiCallInvocationScope](../classes/internal-MultiCallInvocationScope.md)
...
- [InvokeFunctions](../interfaces/internal-InvokeFunctions.md)
...
| `args` | `T` |
| `bytesOffset` | `number` |
| `callParameters?` | [`CallParams`](internal.md#callparams) |
| `forward?` | [`CoinQuantity`](internal.md#coinquantity) |
| `func` | [`FunctionFragment`](../classes/internal-FunctionFragment.md) |
| `program` | [`AbstractProgram`](../classes/internal-AbstractProgram.md) |
| `txParameters?` | [`TxParams`](internal.md#txparams) |

#### Defined in

packages/program/dist/index.d.ts:140

___

### CallParams

Ƭ **CallParams**: `Partial`<{ `forward`: [`CoinQuantityLike`](internal.md#coinquantitylike) ; `gasLimit`: [`BigNumberish`](internal.md#bignumberish)  }\>

#### Defined in

packages/program/dist/index.d.ts:128
...
packages/program/dist/index.d.ts:121
...
| Name | Type |
| :------ | :------ |
| `getCallConfig` | () => [`CallConfig`](internal.md#callconfig)<`T`\> |

#### Defined in

packages/program/dist/index.d.ts:153
...
packages/program/dist/index.d.ts:149
...
Ƭ **TxParams**: `Partial`<{ `gasLimit`: [`BigNumberish`](internal.md#bignumberish) ; `gasPrice`: [`BigNumberish`](internal.md#bignumberish) ; `variableOutputs`: `number`  }\>

#### Defined in

packages/program/dist/index.d.ts:132
