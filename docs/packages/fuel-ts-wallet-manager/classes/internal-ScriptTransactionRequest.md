...
[packages/providers/src/transaction-request/transaction-request.ts:425](https://github.com/FuelLabs/fuels-ts/blob/master/packages/providers/src/transaction-request/transaction-request.ts#L425)
