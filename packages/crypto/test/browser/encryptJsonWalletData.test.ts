import { encryptJsonWalletData, decryptJsonWalletData, randomBytes } from '../../src/index.browser';

/**
 * @group browser
 */
describe('encryptJsonWalletData', () => {
  it('should encrypt and decrypt json wallet data correctly in a browser environment', async () => {
