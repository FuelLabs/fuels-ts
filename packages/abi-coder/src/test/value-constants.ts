...
export const U8_MAX_ENCODED = new Uint8Array([0, 0, 0, 0, 0, 0, 0, 255]);
export const U16_MAX = 2 ** 16 - 1;
export const U16_MAX_ENCODED = new Uint8Array([0, 0, 0, 0, 0, 0, 255, 255]);
...
export const EMPTY_U8_ARRAY = new Uint8Array([0, 0, 0, 0, 0, 0, 0, 0]);
...
export const BOOL_TRUE_ENCODED = new Uint8Array([0, 0, 0, 0, 0, 0, 0, 1]);
