...
describe("StdStringCoder", () => {
	...
	it("should encode [H3llo W0rld]", () => {
		...
		expected.dynamicData = {
			0: new Uint8Array([
				72, 51, 108, 108, 111, 32, 87, 48, 114, 108, 100, 0, 0, 0, 0, 0,
			]),
		};
	...
	it("should encode [abcdefghijklmnopqrstuvwxyz1234567890]", () => {
		...
		expected.dynamicData = {
			0: new Uint8Array([
				...
				112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 49, 50, 51, 52,
	...
	it("should decode a string", () => {
		...
		const input = new Uint8Array([
			0, 0, 0, 0, 0, 0, 49, 120, 0, 0, 0, 0, 0, 0, 0, 11, 0, 0, 0, 0, 0, 0, 0,
			11, 72, 101, 108, 108, 111, 32, 87, 111, 114, 108, 100, 0, 0, 0, 0, 0, 0,
	...
	it("throws when decoding a string with empty byte data", async () => {
		const coder = new StdStringCoder();
		const input = new Uint8Array([
			0, 0, 0, 0, 3, 255, 255, 225, 0, 0, 0, 0, 0, 0, 0, 16, 0, 0, 0, 0, 0, 0,
			0, 255,
		]);
