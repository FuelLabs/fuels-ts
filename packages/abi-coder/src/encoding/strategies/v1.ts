...
import type { EncodingOptions, Coder } from '../coders/abstract-coder';
...
import { StructCoder } from '../coders/v1/struct';
 ...
 */
export class EncodingStrategyV1 implements EncodingStrategy {
  /**
