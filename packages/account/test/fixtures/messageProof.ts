...
export const MESSAGE_PROOF_RAW_RESPONSE: GqlGetMessageProofQuery["messageProof"] =
	{
		messageProof: {
			proofSet: [
				"0x34fdfbc73458998a106b02f13bba51bc0fd36513602e312ca1d1893f2075eca5",
			],
			proofIndex: "0",
		},
		blockProof: {
		...
		messageBlockHeader: {
			...
			transactionsCount: "2",
			transactionsRoot:
				"0xbf760e126159b72f59bde2d59a972620f826e5a5134deb2a775a21c37644e1a1",
			messageReceiptCount: "1",
			height: "432",
			prevRoot:
				"0x26e49e4af2253e0bca68d2a8b38fa7406a546ebc476b6ca51569cb325ad55ea6",
			time: "4611686020115956241",
			applicationHash:
				"0x76b6838a38a3049fa1dd42f923a0f287594a390493003af0f1c3da94f3d2b8c7",
			consensusParametersVersion: "0",
			stateTransitionBytecodeVersion: "0",
			eventInboxRoot:
				"0xe3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
			messageOutboxRoot:
				"0x8817eb3173bc39ae465def50f978153fd84ea4badbe3a4e26486ba7f1bcd0579",
		},
		commitBlockHeader: {
			...
			transactionsCount: "2",
			transactionsRoot:
				"0x471d68713ae2fef6bb3eede37a976b38390f2ab8916e463b22942e7130456a8a",
			...
			time: "4611686020115956241",
			applicationHash:
				"0x441dece8e41d111f3a875ed89d716e48abf450ad385b111cf7c55e06e0b57d6b",
			consensusParametersVersion: "0",
			stateTransitionBytecodeVersion: "0",
			eventInboxRoot:
				"0xe3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
...
export const MESSAGE_PROOF: MessageProof = {
	...
	messageBlockHeader: {
		...
		transactionsCount: Number(
			MESSAGE_PROOF_RAW_RESPONSE.messageBlockHeader.transactionsCount,
		),
		transactionsRoot:
			MESSAGE_PROOF_RAW_RESPONSE.messageBlockHeader.transactionsRoot,
		...
		applicationHash:
			MESSAGE_PROOF_RAW_RESPONSE.messageBlockHeader.applicationHash,
		messageReceiptCount: Number(
			MESSAGE_PROOF_RAW_RESPONSE.messageBlockHeader.messageReceiptCount,
		),
		...
		stateTransitionBytecodeVersion: Number(
			MESSAGE_PROOF_RAW_RESPONSE.messageBlockHeader
				.stateTransitionBytecodeVersion,
		),
		eventInboxRoot:
			MESSAGE_PROOF_RAW_RESPONSE.messageBlockHeader.eventInboxRoot,
		messageOutboxRoot:
			MESSAGE_PROOF_RAW_RESPONSE.messageBlockHeader.messageOutboxRoot,
	},
	commitBlockHeader: {
		id: MESSAGE_PROOF_RAW_RESPONSE.commitBlockHeader.id,
		daHeight: bn(MESSAGE_PROOF_RAW_RESPONSE.commitBlockHeader.daHeight),
		transactionsCount: Number(
			MESSAGE_PROOF_RAW_RESPONSE.commitBlockHeader.transactionsCount,
		),
		transactionsRoot:
			MESSAGE_PROOF_RAW_RESPONSE.commitBlockHeader.transactionsRoot,
		...
		applicationHash:
			MESSAGE_PROOF_RAW_RESPONSE.commitBlockHeader.applicationHash,
		messageReceiptCount: Number(
			MESSAGE_PROOF_RAW_RESPONSE.commitBlockHeader.messageReceiptCount,
		),
		consensusParametersVersion: Number(
			MESSAGE_PROOF_RAW_RESPONSE.commitBlockHeader.consensusParametersVersion,
		),
		stateTransitionBytecodeVersion: Number(
			MESSAGE_PROOF_RAW_RESPONSE.commitBlockHeader
				.stateTransitionBytecodeVersion,
		),
		eventInboxRoot: MESSAGE_PROOF_RAW_RESPONSE.commitBlockHeader.eventInboxRoot,
		messageOutboxRoot:
			MESSAGE_PROOF_RAW_RESPONSE.commitBlockHeader.messageOutboxRoot,
	},
