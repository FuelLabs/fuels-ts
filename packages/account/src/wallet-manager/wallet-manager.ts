...
import { decrypt, encrypt } from '@fuel-ts/crypto';
...
const ERROR_MESSAGES = {
  ...
  passphrase_not_match:
    'The provided passphrase did not match the expected value.',
};
...
export class WalletManager extends EventEmitter {
  ...
  async loadState() {
    ...
    if (data) {
      const state = await decrypt<WalletManagerState>(
        this.#passphrase,
