...
const createNumberCoder = (encodedLength: number, type: string): Coder<number, number> => ({
  type,
...
export const u8: Coder<number, number> = createNumberCoder(1, 'u8');
export const u16: Coder<number, number> = createNumberCoder(2, 'u16');
export const u32: Coder<number, number> = createNumberCoder(4, 'u32');
...
export const b256: Coder<string, string> = createHexCoder(32, 'b256');
export const b512: Coder<string, string> = createHexCoder(64, 'b512');
