 ...
 */
describe(
  'Live experimental contract test',
  () => {
    ...
    it('can use experimental contract on live node', async () => {
      ...
      contractFactory = new ContractFactory(contractBytecode, abi, wallet);
      contractInstance = await contractFactory.deployContract({ gasPrice });
