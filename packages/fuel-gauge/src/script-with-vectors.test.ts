...
import {
  ScriptWithArrayAbi,
  ScriptWithVectorAbi,
  ScriptWithVectorAdvancedAbi,
  ScriptWithVectorMixedAbi,
} from '../test/typegen';
...
describe('Script With Vectors', () => {
  ...
  it('can call script and use main argument [struct in vec in struct in vec in struct in vec]', async () => {
    ...
    const scriptInstance = ScriptWithVectorMixedAbi.createInstance(wallet);
  ...
  it('can call script and use main argument [struct in vec in struct in vec in struct in vec]', async () => {
    ...
    const scriptInstance = ScriptWithVectorAdvancedAbi.createInstance(wallet);
