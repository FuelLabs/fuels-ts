...
describe('expect-to-throw-fuel-error', () => {
  ...
  it(`fails if thrown error doesn't have a code`, async () => {
    ...
    const fnAsync = () =>
      expectToThrowFuelError(throwOtherErrorAsync, fuelError);
  ...
  it(`fails if thrown error code is invalid`, async () => {
    ...
    const fnAsync = () =>
      expectToThrowFuelError(throwFuelErrorInvalidAsync, fuelError);
  ...
  it(`fails if expected error doesn't have a code`, async () => {
    ...
    const fnAsync = () =>
      expectToThrowFuelError(throwFuelErrorAsync, fuelErrorCodeless);
  ...
  it(`fails if expected error code is invalid`, async () => {
    ...
    const fnAsync = () =>
      expectToThrowFuelError(throwFuelErrorAsync, fuelErrorInvalid);
