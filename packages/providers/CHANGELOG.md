...
- re-implement calculateTransactionFee helper, by [@Torres-ssf](https://github.com/Torres-ssf) (See [#1498](https://github.com/FuelLabs/fuels-ts/pull/1498))
...
- bugfix when amount of requested resources to spend is less than 1, by [@nedsalk](https://github.com/nedsalk) (See [#1603](https://github.com/FuelLabs/fuels-ts/pull/1603))
