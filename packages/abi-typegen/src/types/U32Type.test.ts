  ...
  test('should properly parse type attributes', () => {
    const u32 = new U32Type({
      rawAbiType: {
        ...
        typeParameters: null,
        typeId: 1,
        type: U32Type.swayTypeExample,
      },
    });

    u32.parseComponentsAttributes({ types: [] });

    const suitableForU32 = U32Type.isSuitableFor({ type: U32Type.swayTypeExample });
    const suitableForU64 = U32Type.isSuitableFor({ type: U64Type.swayTypeExample });
