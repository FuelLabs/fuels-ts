...
describe("Math - BN", () => {
	...
	it("should toArray accept bytePadding config", () => {
		...
		expect(bn(numberToConvert).toBytes(4)).toEqual(
			Uint8Array.from([0, 0, 0, 0]),
		);
		expect(bn(numberToConvert).toBytes(5)).toEqual(
			Uint8Array.from([0, 0, 0, 0, 0]),
		);
		expect(bn(numberToConvert).toBytes(6)).toEqual(
			Uint8Array.from([0, 0, 0, 0, 0, 0]),
		);
		expect(bn(numberToConvert).toBytes(7)).toEqual(
			Uint8Array.from([0, 0, 0, 0, 0, 0, 0]),
		);
		expect(bn(numberToConvert).toBytes(8)).toEqual(
		...
		expect(bn(numberToConvert).toBytes(5)).toEqual(
			Uint8Array.from([0, 0, 0, 0, 1]),
		);
		expect(bn(numberToConvert).toBytes(6)).toEqual(
			Uint8Array.from([0, 0, 0, 0, 0, 1]),
		);
		expect(bn(numberToConvert).toBytes(7)).toEqual(
			Uint8Array.from([0, 0, 0, 0, 0, 0, 1]),
		);
		expect(bn(numberToConvert).toBytes(8)).toEqual(
		...
		expect(bn(hexToConvert).toBytes(5)).toEqual(
			Uint8Array.from([0, 0, 0, 0, 0]),
		);
		expect(bn(hexToConvert).toBytes(6)).toEqual(
			Uint8Array.from([0, 0, 0, 0, 0, 0]),
		);
		expect(bn(hexToConvert).toBytes(7)).toEqual(
			Uint8Array.from([0, 0, 0, 0, 0, 0, 0]),
		);
		expect(bn(hexToConvert).toBytes(8)).toEqual(
			Uint8Array.from([0, 0, 0, 0, 0, 0, 0, 0]),
		);
	...
	it("should parse to bn unit from decimal/inputs/string values", () => {
		...
		expect(bn.parseUnits("100.00002").toHex()).toEqual(
			bn("100000020000").toHex(),
		);
		expect(bn.parseUnits("100,100.00002").toHex()).toEqual(
			bn("100100000020000").toHex(),
		);
		expect(bn.parseUnits("100,100.00002", 5).toHex()).toEqual(
			bn("10010000002").toHex(),
		);
		expect(bn.parseUnits("1,100,100.00002", 5).toHex()).toEqual(
			bn("110010000002").toHex(),
		);
		expect(bn.parseUnits("100,100,100.00002", 5).toHex()).toEqual(
			bn("10010010000002").toHex(),
		);
