import { WORD_SIZE, encoding } from '@fuel-ts/abi';
...
describe('padded', () => {
  describe('encode', () => {
    it('should encode and pad to word size [u8]', () => {
      const coder = pad(encoding.v1.u8, 1, WORD_SIZE);
    ...
    it('should encode and pad to word size [u16]', () => {
      const coder = pad(encoding.v1.u16, 2, WORD_SIZE);
    ...
    it('should encode and pad to word size [u32]', () => {
      const coder = pad(encoding.v1.u32, 4, WORD_SIZE);
