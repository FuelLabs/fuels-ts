...
import { filterForcBuildFiles, filterOriginalTemplateFiles, getAllFiles } from "./utils/templateFiles";
...
describe('CLI - Integration', () => {
  ...
  it('should perform `pnpm create fuels`', async () => {
    ...
    expectedTemplateFiles = filterOriginalTemplateFiles(expectedTemplateFiles, programsToInclude).filter(filterForcBuildFiles);
