...
`npm create fuels` is a command line tool that helps you scaffold a new fullstack Fuel dApp. In this guide, we will create a new counter dApp using `npm create fuels` and add decrement functionality to it. The final result will look like this:
