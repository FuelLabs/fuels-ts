...
<<< @/../../docs/src/snippets/contracts/deploying-contracts/get-max-size.ts#full{ts:line-numbers}
...
<<< @/../../docs/src/snippets/contracts/deploying-contracts/deployment.ts#setup{ts:line-numbers}
...
<<< @/../../docs/src/snippets/contracts/deploying-contracts/deployment.ts#deploy{ts:line-numbers}
...
<<< @/../../docs/src/snippets/contracts/deploying-contracts/deployment.ts#call{ts:line-numbers}
...
<<< @/../../docs/src/snippets/contracts/deploying-contracts/deployment.ts#blobs{ts:line-numbers}
