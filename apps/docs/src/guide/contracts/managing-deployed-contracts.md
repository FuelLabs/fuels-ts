...
<<< @/../../docs/src/snippets/contracts/managing-deployed-contracts.ts#with-contractId{ts:line-numbers}
...
<<< @/../../docs/src/snippets/contracts/managing-deployed-contracts.ts#with-b256{ts:line-numbers}
