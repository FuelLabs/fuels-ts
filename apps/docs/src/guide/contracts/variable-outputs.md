...
However, this can significantly delay the transaction processing. Therefore it is **highly recommended** to manually add the correct number of Output Variables before submiting the transaction.
