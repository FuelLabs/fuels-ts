...
<<< @/../../docs-snippets2/src/provider/provider-options.ts#retryOptions{ts:line-numbers}

### `requestMiddleware`

Allows you to modify the request object to add additional headers, modify the request's body, and much more.

<<< @/../../docs-snippets2/src/provider/provider-options.ts#requestMiddleware{ts:line-numbers}

### `timeout`

Specify the timeout in milliseconds after which every request will be aborted.

<<< @/../../docs-snippets2/src/provider/provider-options.ts#timeout{ts:line-numbers}
...
<<< @/../../docs-snippets2/src/provider/provider-options.ts#fetch{ts:line-numbers}
...
<<< @/../../docs-snippets2/src/provider/provider-options.ts#cache-utxo{ts:line-numbers}
