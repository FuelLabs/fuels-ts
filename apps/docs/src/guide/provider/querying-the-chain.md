...
<<< @/../../docs/src/snippets/provider/functionality/get-base-asset-id.ts#getBaseAssetId{ts:line-numbers}
...
<<< @/../../docs/src/snippets/provider/functionality/get-coins-from-provider.ts#getCoins-1{ts:line-numbers}

This method is also implemented on the `Account` class and can be used without providing the `address`:

<<< @/../../docs/src/snippets/provider/functionality/get-coins-from-account.ts#getCoins-2{ts:line-numbers}
...
<<< @/../../docs/src/snippets/provider/functionality/get-resources-to-spend-from-provider.ts#getResourcesToSpend-1{ts:line-numbers}

This method is also available in the `Account` class and can be used without providing the `address`:

<<< @/../../docs/src/snippets/provider/functionality/get-resources-to-spend-from-account.ts#getResourcesToSpend-2{ts:line-numbers}
...
<<< @/../../docs/src/snippets/provider/functionality/get-balances.ts#getBalances-1{ts:line-numbers}

This method is also available in the `Account` class and can be used without providing the `address` parameter:

<<< @/../../docs/src/snippets/provider/functionality/get-balances.ts#getBalances-2{ts:line-numbers}
...
<<< @/../../docs/src/snippets/provider/functionality/get-blocks.ts#getBlocks{ts:line-numbers}

## `getMessageByNonce`

You can use the `getMessageByNonce` method to retrieve a message by its nonce.

<<< @/../../docs/src/snippets/provider/functionality/get-messages-by-nonce.ts#getMessageByNonce{ts:line-numbers}

## `getMessages`

You can use the `getMessages` method to retrieve a list of messages from the blockchain.

<<< @/../../docs/src/snippets/provider/functionality/get-messages.ts#getMessages{ts:line-numbers}
...
<<< @/../../docs/src/snippets/provider/functionality/get-message-proof-block-id.ts#getMessageProof-blockId{ts:line-numbers}

Or by it's block height:

<<< @/../../docs/src/snippets/provider/functionality/get-message-proof-block-height.ts#getMessageProof-blockHeight{ts:line-numbers}
...
<<< @/../../docs/src/snippets/provider/functionality/get-transactions.ts#getTransactions{ts:line-numbers}
