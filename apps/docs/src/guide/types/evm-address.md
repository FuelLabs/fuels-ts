...
<<< @/../../docs-snippets/src/guide/types/evm-address.node.browser.test.ts#evm-address-1{ts:line-numbers}
...
<<< @/../../docs-snippets/src/guide/types/evm-address.node.browser.test.ts#evm-address-2{ts:line-numbers}
...
<<< @/../../docs-snippets/src/guide/types/evm-address.node.browser.test.ts#evm-address-3{ts:line-numbers}

And to validate the returned value:

<<< @/../../docs-snippets/src/guide/types/evm-address.node.browser.test.ts#evm-address-4{ts:line-numbers}
