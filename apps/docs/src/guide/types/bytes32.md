...
<<< @/../../docs-snippets/src/guide/types/bytes32.node.browser.test.ts#bytes32-1{ts:line-numbers}
...
<<< @/../../docs-snippets/src/guide/types/bytes32.node.browser.test.ts#bytes32-2{ts:line-numbers}
