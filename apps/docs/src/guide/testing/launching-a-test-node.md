...
<<< @/../../docs-snippets2/src/testing/launching-a-test-node.node.ts#automatic-cleanup{ts:line-numbers}
...
<<< @/../../docs-snippets2/src/testing/launching-a-test-node.node.ts#manual-cleanup{ts:line-numbers}
