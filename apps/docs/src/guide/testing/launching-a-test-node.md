...
<<< @/../../docs/src/snippets/testing/launching-a-test-node.ts#automatic-cleanup{ts:line-numbers}
...
<<< @/../../docs/src/snippets/testing/launching-a-test-node.ts#manual-cleanup{ts:line-numbers}
