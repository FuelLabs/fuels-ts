...
For usage information for `launchTestNode` including it's inputs, outputs and options, please check the [API reference](https://fuels-ts-docs-api.vercel.app/Contract/test-utils-index.md#launchtestnode).
