...
Check out the [API reference](https://fuels-ts-docs-api.vercel.app/Contract/LaunchTestNodeOptions.md) for usage information on the Test Node Options.
...
- `options`: options for [contract deployment](../contracts/deploying-contracts.md#2-contract-deployment) that get passed to the [`ContractFactory.deploy`](https://fuels-ts-docs-api.vercel.app/Contract/ContractFactory.md#deploy) method.
