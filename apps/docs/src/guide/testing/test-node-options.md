...
The `AssetId` utility integrates with [`walletConfig`](./test-node-options.md#walletconfig) and gives you an easy way to generate multiple random asset ids via the `AssetId.random` static method.
...
- `walletIndex`: the index of the wallets generated by [`walletConfig`](./test-node-options.md#walletconfig) that you want to deploy the contract with.
