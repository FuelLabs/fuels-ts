...
console.log(
  'Grouped logs should be defined',
  typeof groupedLogs !== 'undefined'
);
console.log(
  'Should have zeroed log',
  typeof groupedLogs[ZeroBytes32] !== 'undefined'
);
console.log(
  'Should script logs [Script Started]',
  groupedLogs[ZeroBytes32].includes('Script started')
);
console.log(
  'Should script logs [Script Finished]',
  groupedLogs[ZeroBytes32].includes('Script finished')
);
