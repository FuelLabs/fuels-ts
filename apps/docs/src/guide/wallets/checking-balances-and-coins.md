...
<<< @/../../../packages/fuel-gauge/src/doc-examples.node.browser.test.ts#wallet-check-balance{ts:line-numbers}
...
<<< @/../../../packages/fuel-gauge/src/doc-examples.node.browser.test.ts#wallet-check-balances{ts:line-numbers}
