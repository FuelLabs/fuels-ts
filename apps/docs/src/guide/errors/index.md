...
When an [`Account`](https://fuels-ts-docs-api.vercel.app/Account/Account.md) is required for an operation. This will usually be in the form of a [`Wallet`](../wallets/index.md).
...
The type is within [`TransactionType`](https://fuels-ts-docs-api.vercel.app/Account/TransactionType.md).
...
It could be caused by the provider not being set for either an [`Account`](https://fuels-ts-docs-api.vercel.app/Account/index.md) or a [`Wallet`](../wallets/index.md) - use the `connect` method to attach a provider.
