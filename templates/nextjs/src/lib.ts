...
export const localProviderUrl = `http://127.0.0.1:${process.env.NEXT_PUBLIC_FUEL_NODE_PORT || 4000}/v1/graphql`;
...
export const testnetContractId = process.env.NEXT_PUBLIC_TESTNET_CONTRACT_ID as string;
